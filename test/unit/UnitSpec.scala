...
/**
  ...
  *
  * This is useful for testing forms and constraits.
  */
class UnitSpec extends PlaySpec {
  ...
  "WidgetForm" must {
    ...
    "show errors when applied unsuccessfully" in {
      // Pass in a negative price that fails the constraits...
      val data = Map("name" -> "foo", "price" -> "-100")
      ...
      // do it by hand here just to demonstrate what happpens underneath the hood:
      val lang: Long = Lang.defaultLang
